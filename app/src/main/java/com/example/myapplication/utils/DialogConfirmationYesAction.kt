 ...
 */
class DialogConfirmationYesAction : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view = inflater.inflate(R.layout.custom_dialog_confirmation_action, null)
    ...
    fun setOnClick(onClick: DialogInterface) {
